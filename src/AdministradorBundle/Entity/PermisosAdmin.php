...
class PermisosAdmin
{
     ...
     * @var smallint
     *
     * @ORM\Column(name="tipo_permiso", type="smallint", nullable=false)
     */
    private $tipoPermiso;
     ...
     * Set menuAdmin
     *
     * @param \AdministradorBundle\Entity\MenuAdmin $menuAdmin
     *
     * @return PermisosAdmin
     */
    public function setMenuAdmin(\AdministradorBundle\Entity\MenuAdmin $menuAdmin = null)
    {
     ...
     * Get menuAdmin
     *
     * @return \AdministradorBundle\Entity\MenuAdmin
     */
